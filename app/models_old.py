...
#     session_code = db.Column(db.String(10), nullable=False, unique=True)
...
#
#
# class Students(db.models):
#     __tablename__ = 'Students'
#     id = db.Column(db.String, db.ForeignKey('Users.id'), primary_key=True)
#     student_number = db.Column(db.Integer)
#     session_code = db.Column(db.String(), db.ForeignKey('Parameter.session_code'), nullable=False)
#
#     __table_args__ = (
...
#     try:
#         ins_name = recent_added_par.session_code.split('_')[0]
#         ins_code = recent_added_par.session_code.split('_')[1]
...
#         return recent_added_par.session_code
#     except:
...
#                 assert len(
#                     sample_all_new_list) >= recent_added_par.sample_pool_number_of_past_demand_show \
#                        + recent_added_par.nrounds
#                 sample_new_list = sample_all_new_list[
#                                   recent_added_par.sample_pool_number_of_past_demand_show:
#                                   recent_added_par.sample_pool_number_of_past_demand_show + recent_added_par.nrounds]
...
#         assert Demand.query.filter_by(session_code=recent_added_par_pace.session_code).all()
#     except:
#         return 'Complete Parameter or Demand table first!'
#     if recent_added_par_pace.consistent_pace:
#         return recent_added_par_pace.session_code
#     else:
...
#         recent_added_par_pace = Parameter.query.all()[-1]
#         assert Demand.query.filter_by(session_code=recent_added_par_pace.session_code).all()
#         recent_added_user_count_pace = len(Users.query.filter_by(session_code=recent_added_par_pace.session_code).all())
#     except:
#         return 'Complete Parameter or Demand table first!'
#     if recent_added_par_pace.consistent_pace:
...
#             session_code=recent_added_par_pace.session_code).all()]
#     except:
#         return 'Complete Parameter or Demand table first!'
#     if recent_added_par_pace.consistent_pace:
...
#     session_code = db.Column(db.String(10), db.ForeignKey('Parameter.session_code'),
#                              nullable=False, default=default_scode, unique=True)
...
#     session_code = db.Column(db.String(10), db.ForeignKey('Parameter.session_code'), nullable=False)
#     id = db.Column(db.Integer, db.ForeignKey('Students.id'), nullable=False)
#     pname = db.Column(db.String(25), db.ForeignKey('Students.pref_name'), nullable=False)
...
#     demand_id = db.Column(db.Integer, primary_key=True)
#     session_code = db.Column(db.String(10), db.ForeignKey('Parameter.session_code'),
#                              nullable=False, default=default_pace_scode, unique=True)
